  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="absolute top-20 left-20 w-96 h-96 bg-pink-400/40 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '3s' }} />
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-purple-400/35 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s', animationDelay: '1s' }} />
        <div className="absolute top-1/3 right-1/3 w-72 h-72 bg-rose-400/25 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
